...
## Environments
- Preview: https://main--fedex--mrugesh-adobe.aem.page/
- Live: https://main--fedex--mrugesh-adobe.aem.live/
...
1. Open the `fedex` directory in your favorite IDE and start coding :)
